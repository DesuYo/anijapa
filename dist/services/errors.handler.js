...
exports.default = (error, req, res, next) => {
    try {
        switch (true) {
            case error instanceof jsonwebtoken_1.JsonWebTokenError || error instanceof jsonwebtoken_1.TokenExpiredError || error instanceof auth_handler_1.OAuthError: return res
                .status(401)
                .json({ error });
