...
exports.ENUM = (...values) => Joi.allow(values)
exports.$ENUM = (...values) => Joi.allow(values).required()
...
exports.INT = (max = 2**32, def = undefined) => NUM(max).integer().default(def)
exports.$INT = (max = 2**32) => NUM(max).integer().required()

exports.UINT = (max = 2**32, def = undefined) => NUM(max).integer().positive().default(def)
exports.$UINT = (max = 2**32) => NUM(max).integer().positive().required()

exports.FLOAT = (max = 2**32, precision = 3, def = undefined) => NUM(max).precision(precision).default(def)
exports.$FLOAT = (max = 2**32, precision = 3) => NUM(max).precision(precision).required()

exports.UFLOAT = (max = 2**32, precision = 3, def = undefined) => NUM(max).precision(precision).positive().default(def)
exports.$UFLOAT = (max = 2**32, precision = 3) => NUM(max).precision(precision).positive().required()
